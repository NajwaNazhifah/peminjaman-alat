        ...
        <div class="p-5 border-b border-gray-200 bg-gray-50 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <form action="{{ route('admin.peminjaman.index') }}" method="GET" class="flex w-full md:w-auto">
                    ...
                    <button type="submit" class="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 text-sm font-semibold rounded-r-lg transition">
                        Cari
                    </button>
                </form>
                @if(request('search'))
                    ...
                    @forelse($peminjamans as $peminjaman)
                        <tr class="hover:bg-gray-50 transition align-top">
                            ...
                            <td class="py-3 px-4 border-b text-xs text-gray-500">
                                <span class="block"><i class="fas fa-play"></i> {{ $peminjaman->tgl_pinjam }}</span>
                                <span class="block mt-1"><i class="fas fa-undo"></i> {{ $peminjaman->tgl_kembali_plan }}</span>
                            </td>
                            <td class="py-3 px-4 border-b">
