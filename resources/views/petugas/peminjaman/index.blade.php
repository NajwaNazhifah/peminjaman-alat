...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        ...
        <div class="p-5 border-b border-gray-200 bg-gray-50">
            ...
            <form action="{{ route('petugas.peminjaman.index') }}" method="GET" class="flex w-full md:w-80 mt-4">
                ...
                <button
                    type="submit"
                    class="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 text-sm font-semibold rounded-r-lg transition"
                >
                    Cari
                </button>
